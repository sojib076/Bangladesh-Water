...
const GoToTopButton: React.FC = () => {
  ...
  return (
    isVisible && (
      <button
        onClick={scrollToTop}
        className="group fixed bottom-5 right-5 p-3 rounded-full bg-green-400 text-white shadow-lg
         hover:bg-black hover:scale-90 transition-colors smoothingAnimation  "
      >
